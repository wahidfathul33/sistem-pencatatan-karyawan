...
var KTSearch = function (element, options) {
    ...
    var defaultOptions = {
        ...
        layout: 'menu',  // Use 'menu' or 'inline' layouts options to display search results
        ...
        previewButton.addEventListener("click", function (e) {
            ...
            $.ajax({
                ...
                success: function (response, status, xhr) {
                    ...
                    toastr.success(
                        "Preview has been updated with current configured layouts.",
                        "Preview updated!",
            ...
            $.ajax({
                ...
                success: function (response, status, xhr) {
                    var timer = setInterval(function () {
                        $("<iframe/>").attr({
                            src: url + "?layouts-builder[action]=export&download=1&output=" + response,
