<div class="modal" id="editModal" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static"
                ...
                <div class="modal-body">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <textarea
                            ...
                            type="text" wire:model.defer="hasil_kinerja" placeholder="Masukkan Hasil Kinerja"></textarea>
                        @error('hasil_kinerja')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
